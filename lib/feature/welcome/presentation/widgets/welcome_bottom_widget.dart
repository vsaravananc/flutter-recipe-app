...
class WelcomeBottomWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ClipPath(
      clipper: const _InvertedTopClipper(),
      child: Container(
...
class _InvertedTopClipper extends CustomClipper<Path> {
  const _InvertedTopClipper();
  ...
  @override
  bool shouldReclip(covariant _InvertedTopClipper oldClipper) {
    return false;
  }
}
