...
class RemoteDataImplUserSugestion implements RemoteDataRepoUserSugestion {
  final Dio dio;
  ...
  @override
  Future<Getlistofarearemote> getListOfArea() async {
    try {
      ...
      for (AreaModel i in convertedValue) {
        debugPrint("\u001B[32 m area remote model : ${i.area} \u001B[0m");
      }
  ...
  @override
  Future<Getlistofcategoryremote> getListOfCategory() async {
    try {
      ...
      for (CategoryModel i in convertedValue) {
        debugPrint(
          "\u001B[32 m category  remote model : ${i.category} \u001B[0m",
        );
      }
      return Right(SuccessHandlerImpl(convertedValue));
    } on DioException catch (e) {
  ...
  @override
  Future<void> selectedArea(AreaModel area, String uuid) async {
